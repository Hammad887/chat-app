...
// ChatRoomParams contains all the bound params for the chat room operation
...
//
// To ensure default values, the struct must have been initialized with NewChatRoomParams() beforehand.
func (o *ChatRoomParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
