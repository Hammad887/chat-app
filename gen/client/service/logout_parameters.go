...
// WithLogout adds the logout to the logout params
func (o *LogoutParams) WithLogout(logout *models.Token) *LogoutParams {
	o.SetLogout(logout)
	return o
}

// SetLogout adds the logout to the logout params
func (o *LogoutParams) SetLogout(logout *models.Token) {
	o.Logout = logout
}
...
func (o *LogoutParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	var res []error
	if o.Logout != nil {
		if err := r.SetBodyParam(o.Logout); err != nil {
			return err
		}
	}
