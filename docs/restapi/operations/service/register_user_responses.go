...
func (o *RegisterUserCreated) WithPayload(payload *models.SuccessResponse) *RegisterUserCreated {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the register user created response
func (o *RegisterUserCreated) SetPayload(payload *models.SuccessResponse) {
	o.Payload = payload
}
